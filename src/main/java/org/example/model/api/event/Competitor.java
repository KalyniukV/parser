...
package org.example.model.api.event;
...
public class Competitor {
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name)))&&((this.homeAway == rhs.homeAway)||((this.homeAway!= null)&&this.homeAway.equals(rhs.homeAway))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
